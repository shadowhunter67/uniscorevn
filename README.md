...
|---|---:|---|
| ✅ Tính được điểm xét tuyển | 181 | Công thức, ngưỡng, điểm cộng và điểm ưu tiên đều có nguồn chính thức trong phạm vi đã công bố. |
...
| ⚪ Đã có thông tin tuyển sinh | 62 | Đã có thông tin tuyển sinh chính thức, nhưng chưa đủ để tính điểm hay kết luận điều kiện. |
