...
| Chỉ kiểm tra điều kiện/ngưỡng | 19 |
| Có calculator một phần | 3 |
| Calculator đã xác minh | 145 |
...
|---|---:|---|
| ✅ Tính được điểm xét tuyển | 145 | Công thức, ngưỡng, điểm cộng và điểm ưu tiên đều có nguồn chính thức trong phạm vi đã công bố. |
| 🟡 Tính được một phần | 3 | Có công thức thật nhưng chưa phủ hết mọi phương thức xét tuyển của trường. |
| 🟡 Kiểm tra được điều kiện | 19 | Có ngưỡng điểm sàn/điều kiện chính thức, chưa tính được điểm xét tuyển đầy đủ. |
