...
| KPI | Số lượng |
|---|---:|
| Mục trong danh mục/search/compare | 356 |
| Cơ sở giáo dục độc lập trong danh mục | 344 |
| Đơn vị nội bộ/không tính vào KPI cơ sở | 12 |
| Đại học / cơ sở hệ đại học | 236 |
| Học viện | 22 |
...
|---|---:|---|
| ✅ Tính được điểm xét tuyển | 183 | Công thức, ngưỡng, điểm cộng và điểm ưu tiên đều có nguồn chính thức trong phạm vi đã công bố. |
...
| ⚪ Đã có thông tin tuyển sinh | 60 | Đã có thông tin tuyển sinh chính thức, nhưng chưa đủ để tính điểm hay kết luận điều kiện. |
