...
|---|---:|---|
| ✅ Calculator đã xác minh | 34 | Công thức, ngưỡng, điểm cộng/ưu tiên đều có nguồn chính thức trong phạm vi đã công bố |
| 🟡 Calculator một phần | 3 | Có công thức/quy đổi thật nhưng chưa phủ hết phương thức xét tuyển |
| 🟡 Chỉ kiểm tra điều kiện/ngưỡng | 70 | Có ngưỡng điểm sàn/điều kiện thật, chưa tính được điểm xét tuyển đầy đủ |
