...
| Nhóm độc lập khác | 0 |
| Có dữ liệu tuyển sinh hoặc capability cao hơn | 233 |
| Chỉ kiểm tra điều kiện/ngưỡng | 14 |
| Có calculator một phần | 3 |
| Calculator đã xác minh | 151 |
| Chỉ có trong danh mục | 121 |
<!-- coverage:kpi:end -->
...
|---|---:|---|
| ✅ Tính được điểm xét tuyển | 151 | Công thức, ngưỡng, điểm cộng và điểm ưu tiên đều có nguồn chính thức trong phạm vi đã công bố. |
...
| ⚪ Chưa có dữ liệu tuyển sinh | 121 | Trường có trong danh mục nhưng UniScoreVN chưa tìm được nguồn tuyển sinh chính thức nào. |
