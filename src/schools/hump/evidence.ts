...
export const humpExactFormulaEvidence = {
  value:
  ...
  evidence: [
    {
      ...
      location: 'Bảng điểm chuẩn theo ngành, Trường Đại học Y - Dược, Đại học Huế 2025 (tuyensinh247, cross-check Báo Hà Tĩnh).',
...
export const humpFieldThresholdEvidence = {
  ruleId: 'hump-field-threshold-2025',
  evidence: [
    {
      sourceId: 'hump-threshold-2025',
    ...
    {
      sourceId: 'hump-threshold-secondary-2025',
      location: 'Cross-check độc lập qua Báo Hà Tĩnh — khớp TUYỆT ĐỐI 10/11 ngành theo TỪNG tổ hợp (thiếu riêng Y khoa trong bảng cross-check nhưng không mâu thuẫn).',
      verification: 'verified' as const,
      effectiveYear: 2025,
      verifiedAt: '2026-09-02',
    },
