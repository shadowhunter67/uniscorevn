...
import { epuSources } from './epu/sources';
import { unetiSources } from './uneti/sources';
import { ulsaSources } from './ulsa/sources';
import { huphSources } from './huph/sources';
import { vutmSources } from './vutm/sources';
import { hmtuSources } from './hmtu/sources';
import { ndunSources } from './ndun/sources';
import { vmuvinhSources } from './vmuvinh/sources';
...
import { vyaSources } from './vya/sources';
import { trungvuongSources } from './trungvuong/sources';
import { dsuSources } from './dsu/sources';
...
export const epuSourceRegistry: AdmissionSource[] = withSchoolId('epu', epuSources);
export const unetiSourceRegistry: AdmissionSource[] = withSchoolId('uneti', unetiSources);
export const ulsaSourceRegistry: AdmissionSource[] = withSchoolId('ulsa', ulsaSources);
export const huphSourceRegistry: AdmissionSource[] = withSchoolId('huph', huphSources);
export const vutmSourceRegistry: AdmissionSource[] = withSchoolId('vutm', vutmSources);
export const hmtuSourceRegistry: AdmissionSource[] = withSchoolId('hmtu', hmtuSources);
export const ndunSourceRegistry: AdmissionSource[] = withSchoolId('ndun', ndunSources);
export const vmuvinhSourceRegistry: AdmissionSource[] = withSchoolId('vmuvinh', vmuvinhSources);
...
export const vyaSourceRegistry: AdmissionSource[] = withSchoolId('vya', vyaSources);
export const trungvuongSourceRegistry: AdmissionSource[] = withSchoolId('trungvuong', trungvuongSources);
export const dsuSourceRegistry: AdmissionSource[] = withSchoolId('dsu', dsuSources);
...
export const schoolSourceRegistries: Record<string, AdmissionSource[]> = {
  ...
  epu: epuSourceRegistry,
  uneti: unetiSourceRegistry,
  ulsa: ulsaSourceRegistry,
  huph: huphSourceRegistry,
  vutm: vutmSourceRegistry,
  hmtu: hmtuSourceRegistry,
  ndun: ndunSourceRegistry,
  vmuvinh: vmuvinhSourceRegistry,
  ...
  vya: vyaSourceRegistry,
  trungvuong: trungvuongSourceRegistry,
  dsu: dsuSourceRegistry,
