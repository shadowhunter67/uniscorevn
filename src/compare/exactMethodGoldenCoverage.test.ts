...
import { hauiThptExamExactGoldenCases } from '../schools/haui/__fixtures__/officialExamples2026';
import { bavThptExamExactGoldenCases } from '../schools/bav/__fixtures__/officialExamples2026';
import { phenikaaThptExamExactGoldenCases } from '../schools/phenikaa/__fixtures__/officialExamples2026';
import { houThptExamExactGoldenCases } from '../schools/hou/__fixtures__/officialExamples2026';
import { lhuThptExamExactGoldenCases } from '../schools/lhu/__fixtures__/officialExamples2026';
import { hnmuThptExamExactGoldenCases } from '../schools/hnmu/__fixtures__/officialExamples2026';
import { cmcuThptExamExactGoldenCases } from '../schools/cmcu/__fixtures__/officialExamples2026';
...
const allGoldenCases = [
  ...
  ...hauiThptExamExactGoldenCases,
  ...bavThptExamExactGoldenCases,
  ...phenikaaThptExamExactGoldenCases,
  ...houThptExamExactGoldenCases,
  ...
  it('reports the current exact-method inventory (documentation aid, not a strict assertion)', () => {
    expect([...exactMethods].sort()).toEqual(
      [
        ...
        'haui:haui-thpt-exam-exact-2026',
        'bav:bav-thpt-exam-exact-2026',
        'phenikaa:phenikaa-thpt-exam-exact-2026',
        'hou:hou-thpt-exam-exact-2026',
