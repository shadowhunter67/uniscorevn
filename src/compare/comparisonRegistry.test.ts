...
import { hanuAdmissionMethods } from '../schools/hanu/methods';
...
import { hustAdmissionMethods } from '../schools/hust/methods';
...
import { bmtuAdmissionMethods } from '../schools/bmtu/methods';
import { hcaAdmissionMethods } from '../schools/hca/methods';
import { naemAdmissionMethods } from '../schools/naem/methods';
...
import { bavAdmissionMethods } from '../schools/bav/methods';
...
import { hpmuAdmissionMethods } from '../schools/hpmu/methods';
import { vnuebAdmissionMethods } from '../schools/vnueb/methods';
import { vnuedAdmissionMethods } from '../schools/vnued/methods';
import { tvuAdmissionMethods } from '../schools/tvu/methods';
import { qnuAdmissionMethods } from '../schools/qnu/methods';
...
import { htuAdmissionMethods } from '../schools/htu/methods';
import { dumtpAdmissionMethods } from '../schools/dumtp/methods';
...
import { dnuAdmissionMethods } from '../schools/dnu/methods';
...
import { hucAdmissionMethods } from '../schools/huc/methods';
import { hunreAdmissionMethods } from '../schools/hunre/methods';
import { humpAdmissionMethods } from '../schools/hump/methods';
...
import { vwaAdmissionMethods } from '../schools/vwa/methods';
import { hauAdmissionMethods } from '../schools/hau/methods';
import { ctumpAdmissionMethods } from '../schools/ctump/methods';
import { tbuAdmissionMethods } from '../schools/tbu/methods';
import { dthuAdmissionMethods } from '../schools/dthu/methods';
...
const methodDescriptorsBySchool: Record<string, readonly { id: string }[]> = {
  ...
  hust: hustAdmissionMethods,
  apd: apdAdmissionMethods,
  bdu: bduAdmissionMethods,
  bvu: bvuAdmissionMethods,
  bmtu: bmtuAdmissionMethods,
  hca: hcaAdmissionMethods,
  naem: naemAdmissionMethods,
